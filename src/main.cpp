...
const int defaultRoom = 3;  // BATH ROOM
...
void GetPreferences()
{
  ...
  tempControl.setRelayTempCoefOn(preferences.getFloat("tCoefOn", 0.60));
  tempControl.setRelayTempCoefOff(preferences.getFloat("tCoefOff", 0.40));
  preferences.end();
}
